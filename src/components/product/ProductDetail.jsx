        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-6">
          ...
          <div className="bg-black/40 backdrop-blur-md rounded-xl p-8 border border-blue-900/50 shadow-[0_0_15px_rgba(0,191,255,0.3)] transform -rotate-1">
            <div className="transform rotate-1">
              ...
              {/* Color Selection */}
              <div className="mb-6">
                <h3 className="text-sm font-medium text-blue-300 mb-3 text-glow-blue">
                  Color
                </h3>
              ...
              <div className="mb-6">
                <div className="flex items-center justify-between mb-3">
                  <h3 className="text-sm font-medium text-blue-300 text-glow-blue">
                    Size
                  </h3>
                  <Link
                    to="/size-guide"
                    className="text-sm font-medium text-blue-400 hover:text-blue-300 hover:underline transition-all duration-300"
                  >
                    Size guide
                  </Link>
                </div>
              ...
              <div className="bg-blue-950/30 backdrop-blur-sm rounded-lg p-4 mb-6 border border-blue-900/30">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  />
                  <div>
                    <h4 className="font-medium text-blue-300 text-glow-blue">
                      Free Shipping
                    </h4>
