...
const categories = [
  ...
  },
  {
    name: "Crop Tops",
    image:
      "https://img.ltwebstatic.com/images/pi/201711/e8/15115155444351802642.jpg",
    count: 24,
  },
  {
    name: "Hoodies",
    image:
      "https://i5.walmartimages.com/seo/Hat-and-Beyond-Women-s-Ultra-Soft-Fleece-Hoodie-Customizable-Oversized-Pullover-Hoodie-With-Half-Moon-Patch-For-Custom-Branding_f0e356ec-3da8-45e2-b3ba-4d2bb720d286.aaf8f235753f53b6f0fd56f6943ed925.jpeg",
    count: 19,
  },
  {
    name: "Accessories",
    image:
      "https://nilsonline.lk/image/catalog/nils/accessories/accessories.jpg",
    count: 27,
  },
];
          ...
          <div className="relative rounded-2xl overflow-hidden mb-12">
            ...
            <div className="absolute inset-0 z-20 flex flex-col justify-center p-8 md:p-16">
              ...
              <p className="text-blue-300 text-lg md:text-xl max-w-md mb-6">
                Embrace your inner heroine with our exclusive range of
                superhero-inspired women's apparel.
              </p>
              <Link
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {categories.map((category, index) => (
                <div
                  key={index}
                  className="group relative rounded-xl overflow-hidden bg-background backdrop-blur-md border border-primary shadow-[0_0_15px_rgba(0,191,255,0.3)] transition-transform duration-300 hover:scale-105"
                >
                  <div className="aspect-square overflow-hidden">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-background via-secondary to-transparent"></div>
                    <div className="absolute inset-0 flex flex-col items-center justify-center p-4 text-center">
                      <h3
                        className="text-xl font-bold text-primary mb-2"
                        style={{
                          textShadow: "0 0 10px rgba(100, 200, 255, 0.7)",
                        }}
                      >
                        {category.name}
                      </h3>
                      ...
                      <Link
                        ...
                        className="bg-background hover:bg-secondary text-blue-300 py-2 px-4 rounded-lg border border-primary backdrop-blur-sm shadow-[0_0_10px_rgba(0,191,255,0.3)] transition-all duration-300"
                      >
                        View All
                      </Link>
                    </div>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {featuredProducts.map((product) => (
                ...
                >
                  <div className="bg-background backdrop-blur-md border border-primary rounded-xl overflow-hidden shadow-[0_0_15px_rgba(0,191,255,0.3)]">
                    {/* Product Image */}
                    <div className="relative aspect-[3/4] overflow-hidden">
                      ...
                      {product.isNew && (
                        <div className="absolute top-2 left-2">
                          <span className="bg-primary text-white text-xs font-bold px-2 py-1 rounded-md backdrop-blur-sm">
                            NEW
                          </span>
                        </div>
                      )}
                    ...
                    {/* Product Info */}
                    <div className="p-4">
                      <h3 className="text-primary font-medium text-sm mb-1 line-clamp-2">
                        {product.name}
                      </h3>
          ...
          <div className="relative rounded-2xl overflow-hidden mb-16">
            ...
            <div className="absolute inset-0 z-20 flex flex-col justify-center p-8 md:p-16">
              ...
              <p className="text-blue-300 text-lg max-w-md mb-6">
                New arrivals featuring your favorite heroines. Get 20% off with
                code HERO20.
              </p>
              <Link
                to="/products?collection=summer"
                className="inline-flex items-center bg-primary hover:bg-secondary text-blue-300 py-3 px-6 rounded-lg border border-primary backdrop-blur-sm shadow-[0_0_15px_rgba(0,191,255,0.3)] transition-all duration-300 w-fit"
              >
