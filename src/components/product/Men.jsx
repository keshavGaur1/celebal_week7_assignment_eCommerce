...
const categories = [
  {
    name: "Graphic Tees",
    image:
      "https://i.pinimg.com/originals/3c/4b/c6/3c4bc697ab443981b57ecda389db42a1.jpg",
    count: 42,
  },
  {
    name: "Oversized Fits",
    image:
      "https://tse3.mm.bing.net/th?id=OIP.VzFeft62u1aa9ExKweqo-AAAAA&pid=Api&P=0&h=180",
    count: 28,
  },
  {
    name: "Hoodies",
    image:
      "https://1.bp.blogspot.com/-Z-7bRmz1pfc/VWQThXBIbZI/AAAAAAAAAGs/xWsujezxU6M/s1600/hoodie2.jpg",
    count: 16,
  },
  {
    name: "Accessories",
    image:
      "https://tse1.mm.bing.net/th?id=OIP.FxwrviRZ3Acu-y1NJWRRigHaHa&pid=Api&P=0&h=180",
    count: 23,
  },
];
          ...
          <div className="relative rounded-2xl overflow-hidden mb-12">
            ...
            <div className="absolute inset-0 z-20 flex flex-col justify-center p-8 md:p-16">
              ...
              <p className="text-blue-300 text-lg md:text-xl max-w-md mb-6">
                Discover our exclusive range of superhero-inspired apparel
                designed for the modern hero.
              </p>
              <Link
                  ...
                  <div className="aspect-square overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center p-4 text-center">
                      ...
                      <Link
                        ...
                        className="bg-primary hover:bg-secondary text-blue-300 py-2 px-4 rounded-lg border border-primary backdrop-blur-sm shadow-[0_0_10px_rgba(0,191,255,0.3)] transition-all duration-300"
                      >
                        View All
                      </Link>
                    </div>
          ...
          <div className="relative rounded-2xl overflow-hidden mb-16">
            ...
            <div className="absolute inset-0 z-20 flex flex-col justify-center p-8 md:p-16">
              ...
              <p className="text-blue-300 text-lg max-w-md mb-6">
                Exclusive Marvel & DC collaboration. Available for a limited
                time only.
              </p>
              <Link
