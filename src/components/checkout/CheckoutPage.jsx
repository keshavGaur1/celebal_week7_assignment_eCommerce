...
const CheckoutPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (step < 3) {
      ...
      // Process order: clear cart and redirect
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center p-3 rounded-lg bg-slate-700/50 border border-purple-500/30">
                          ...
                          >
                            ...
                            <span className="text-sm text-slate-400">
                              {subtotal > 499 ? "Free" : "₹49"} - Delivery in
                              4-6 business days
                            </span>
                          </label>
                        </div>
                        <div className="flex items-center p-3 rounded-lg bg-slate-700/50 border border-purple-500/30">
                          ...
                          >
                            ...
                            <span className="text-sm text-slate-400">
                              ₹99 - Delivery in 1-2 business days
                            </span>
                          </label>
                        </div>
                      </div>
                    ...
                    {paymentMethod === "upi" && (
                      <div className="bg-slate-700/70 p-4 rounded-lg mb-6 border border-purple-500/30">
                        <p className="text-sm text-slate-300 mb-4">
                          ...
                          your UPI app after reviewing your order.
                        </p>
                      </div>
                    )}
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="bg-slate-700/70 p-4 rounded-lg border border-purple-500/30">
                        ...
                        {paymentMethod === "upi" && (
                          <p className="text-slate-300">UPI Payment</p>
                        )}
                        {paymentMethod === "cod" && (
                          <p className="text-slate-300">Cash on Delivery</p>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="mb-6">
                      ...
                      <div className="bg-slate-700/70 p-4 rounded-lg border border-purple-500/30">
                        {cartItems.map((item) => (
                          <div
                            key={item.id}
                            className="flex items-center py-2 border-b border-slate-600 last:border-0"
                          >
            ...
            <div className="lg:col-span-1">
              <div className="bg-slate-800 rounded-lg p-6 border border-purple-500/30 sticky top-4 backdrop-blur-sm shadow-lg relative overflow-hidden">
                ...
                <h2 className="text-lg font-bold text-purple-300 mb-4 relative z-10">
                  Order Summary
                </h2>
                ...
                <div className="space-y-4 relative z-10">
                  <div className="flex items-start bg-slate-700/40 p-3 rounded-lg border border-purple-500/20">
                    <Truck
                      className="text-purple-400 mt-0.5 flex-shrink-0 mr-3"
                      size={18}
                    />
                    <div>
                      <h4 className="text-sm font-medium text-purple-200">
