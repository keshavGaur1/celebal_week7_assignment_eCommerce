  ...
  return (
    <div className="flex flex-col min-h-screen overflow-hidden relative">
      ...
      <div className="fixed inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-green-900 via-green-950 to-green-900"></div>
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at 70% 30%, rgba(0, 191, 255, 0.3) 0%, transparent 25%), radial-gradient(circle at 30% 70%, rgba(138, 43, 226, 0.3) 0%, transparent 25%)",
          }}
        ></div>
