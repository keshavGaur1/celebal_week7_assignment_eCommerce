...
//     <div className="min-h-screen bg-gradient-to-b from-background to-indigo-950">
//       <Header/>
...
//                 style={{
//                   backgroundImage: `
//                     radial-gradient(1px 1px at 25% 25%, text-primary 1%, transparent 1%),
//                     radial-gradient(1.5px 1.5px at 50% 50%, text-primary 1%, transparent 1%),
//                     radial-gradient(1px 1px at 75% 75%, text-primary 1%, transparent 1%)
//                   `,
...
//                 <div className="md:w-1/2 mb-8 md:mb-0 text-primary space-y-6">
...
//                     <Link
//                       to="/shop"
//                       className="inline-flex items-center bg-primary hover:bg-primary/80 text-white font-medium py-3 px-6 rounded-md transition-colors shadow-lg hover:shadow-primary/500/50"
//                     >
//                       {slide.buttonText}
...
//             className="absolute left-4 top-1/2 transform -translate-y-1/2 z-30 bg-background/30 hover:bg-background/50 text-primary p-2 rounded-full transition-colors"
//           >
//             <ChevronLeft size={24} />
//           </button>
//           <button
//             onClick={goToNextSlide}
//             className="absolute right-4 top-1/2 transform -translate-y-1/2 z-30 bg-background/30 hover:bg-background/50 text-primary p-2 rounded-full transition-colors"
//           >
...
//       {/* Featured Categories */}
//       <section className="py-16 bg-background/40 backdrop-blur-sm">
...
//               >
//                 <div className="absolute inset-0 bg-gradient-to-b from-primary/80 to-background/90 group-hover:from-primary/80 transition-all duration-300"></div>
//                 <div className="absolute inset-0 flex flex-col items-center justify-center p-6 text-center">
//                   <h3 className="text-2xl font-bold text-primary mb-2">{category}</h3>
//                   <span className="inline-block w-12 h-1 bg-primary mb-4 transform group-hover:w-24 transition-all duration-300"></span>
//                   <p className="text-secondary">Discover premium designs</p>
//                 </div>
...
//                     : "bg-background/40 text-primary hover:bg-background/60"
//                 }`}
//               >
//                 {tab}
//               </button>
...
//             <Link
//               to="/shop"
//               className="inline-flex items-center bg-primary hover:bg-primary/80 text-white font-medium py-3 px-6 rounded-md transition-colors shadow-lg"
//             >
//               View All Products
...
//               <div
//                 key={index}
//                 className="bg-background/30 backdrop-blur-sm p-6 rounded-lg border border-primary/30 hover:border-primary/60 transition-all hover:shadow-lg hover:shadow-primary/20"
//               >
...
//       <section className="py-16">
//         <div className="container mx-auto px-4">
//           <div className="bg-gradient-to-r from-primary to-secondary rounded-lg p-8 md:p-12 shadow-xl relative overflow-hidden">
//             {/* Star effect overlay */}
//             <div
...
//               <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">Join Our Universe</h2>
...
//                   className="px-4 py-3 rounded-md focus:outline-none focus:ring-2 focus:ring-primary bg-background border border-primary/50 text-primary placeholder-secondary min-w-[250px]"
//                 />
//                 <button className="bg-primary hover:bg-primary/80 text-white font-medium py-3 px-6 rounded-md transition-colors shadow-lg whitespace-nowrap">
//                   Subscribe Now
//                 </button>
//               </div>
//             </div>
